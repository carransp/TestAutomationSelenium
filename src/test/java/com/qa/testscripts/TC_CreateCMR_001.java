...
public class TC_CreateCMR_001 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://createcmr.c360-dev-cluster.us-south.containers.appdomain.cloud/CreateCMR/login");
		...
		if(title.contains("CreateCMR")) {
			System.out.println("CreateCMR page is loaded");
		}
